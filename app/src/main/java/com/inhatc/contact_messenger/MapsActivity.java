...
import com.inhatc.contact_messenger.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        String sLati =  getIntent().getStringExtra("Lati");
        String sLong = getIntent().getStringExtra("Long");
        double dLatitude = Double.parseDouble(sLati);
        double dLongitude = Double.parseDouble(sLong);
        LatLng objLocation;

        // Add a marker in Sydney and move the camera
        objLocation = new LatLng(dLatitude,dLongitude);
        mMap.addMarker(new MarkerOptions().position(objLocation));
